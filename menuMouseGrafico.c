//g++ menus22.cpp -o menus22 -lglut -lGL -lGLU
...
glutAddMenuEntry("Bluee",2);
submenu2 = glutCreateMenu(MenuPrimitiva);
glutAddMenuEntry("Quadrado",0);
glutAddMenuEntry("Triagulo",1);
glutAddMenuEntry("Rombo",2);
...
glutCreateWindow("Exemplo de Menu e Exibiçio de Caracteres");
